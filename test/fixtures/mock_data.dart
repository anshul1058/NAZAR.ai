import 'package:nazar_ai/models/child.dart';
import 'package:nazar_ai/models/detection.dart';

/// Fixture data for unit tests & widget tests.
/// Used by test/ wherever a `Child` or `Detection` instance is needed.
class MockData {
